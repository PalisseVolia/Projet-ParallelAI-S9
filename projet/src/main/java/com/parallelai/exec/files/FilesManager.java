...
/**
 * Gestionnaire de fichiers permettant la manipulation des modèles CNN, MLP et des jeux de données.
 * Cette classe fournit une interface utilisateur en ligne de commande pour gérer les fichiers
...
public class FilesManager {
     ...
     * 
     * @param type Le type de fichier à gérer (1 pour CNN, 2 pour MLP, 3 pour Datasets)
     */
